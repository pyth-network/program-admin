...
class AcceptAccounts(typing.TypedDict):
...
def accept(
    ...
    keys: list[AccountMeta] = [
        AccountMeta(
            pubkey=accounts["current_authority"], is_signer=False, is_writable=False
        ),
        AccountMeta(
            pubkey=accounts["new_authority"], is_signer=True, is_writable=False
        ),
